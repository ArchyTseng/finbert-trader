...
def main():
    ...
    try:
        ...
        # Define custom configs for setup and trading
        custom_setup_config = {
            'symbols': ['GOOGL', 'AAPL'],  # Multi-stock for portfolio test
            # Optional expansion: ['GOOGL', 'AAPL', 'MSFT', 'AMZN', 'NVDA', 'AMD', 'TSLA', 'META']
            'start': '2015-01-01',
            'end': '2023-12-31',
            'train_start_date': '2015-01-01',
            'train_end_date': '2021-12-31',
        ...
        custom_trading_config = {
            'initial_cash': 100000,
            'total_timesteps': 200000  # Reduced for testing (200K steps), use 2000000 for full training
        }

        # Execute the pipeline with configs
        pipeline_results = execute_pipeline(custom_setup_config, custom_trading_config)
